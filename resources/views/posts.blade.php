...
<div class="card mb-3">
    <div class="card-body text-center">
        ...
        <p><small class="text-body-secondary">
                ...
                </a> In <a href="/posts?category={{$posts[0]->category->slug}}"
                    class="text-decoration-none">{{ $posts[0]->category->slug}}</a> {{ $posts[0]->created_at->diffForHumans() }}
            </small>
        </p>
        ...
        <div class="col-md-4 mb-3">
            <div class="card">
                <div class="px-3 py-2 text-dark">
                    <a href="/posts?category={{$post->category->slug}}" class="text-decoration-none text-dark">{{ $post->category->name }}</a>
                </div>
                @if($post->image)
